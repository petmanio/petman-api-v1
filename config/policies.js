...
module.exports.policies = {
  ...
  ***************************************************************************/
  ...
  RoomController: {
    ...
    'list': ['getUser'],
    'getApplicationList': ['tokenAuth', 'roomExists'],
    'deleteById': ['tokenAuth', 'roomExists', 'isRoomOwner'],
  ...
  WalkerController: {
    ...
    'list': ['getUser'],
    'getApplicationList': ['tokenAuth', 'walkerExists'],
    'deleteById': ['tokenAuth', 'walkerExists', 'isWalkerOwner'],
